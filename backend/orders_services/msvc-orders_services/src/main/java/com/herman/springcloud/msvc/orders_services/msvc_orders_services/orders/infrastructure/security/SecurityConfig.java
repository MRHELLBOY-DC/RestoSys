    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/orders/*/status").hasAnyRole("restaurante", "admin")
                        .requestMatchers(HttpMethod.GET, "/api/orders/client/*").hasAnyRole("cliente", "admin")
                        .requestMatchers(HttpMethod.GET, "/api/orders/active").hasAnyRole("restaurante", "admin")
                        .requestMatchers(HttpMethod.GET, "/api/orders/history").hasAnyRole("restaurante", "admin")
                        .requestMatchers(HttpMethod.GET, "/api/orders/code/*").hasAnyRole("cliente", "restaurante", "admin")
                        .requestMatchers(HttpMethod.GET, "/api/orders/*").hasAnyRole("cliente", "restaurante", "admin")
